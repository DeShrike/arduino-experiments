...
void analogMeter()
{
  ...
  for (int i = -50; i < 51; i += 5) {
    ...
    if (i % 25 == 0) {
      ...
      switch (i / 25) {
        case -2: 
          // ICI tft.drawCenterString("0", x0+4, y0-4, 1); 
          break;
        case -1: 
          // ICI tft.drawCenterString("25", x0+2, y0, 1); 
          break;
        case 0: 
          // ICI tft.drawCenterString("50", x0, y0, 1); 
          break;
        case 1: 
          // ICI tft.drawCenterString("75", x0, y0, 1); 
          break;
        case 2: 
          // ICI tft.drawCenterString("100", x0-2, y0-4, 1); 
          break;
      }
    }
  ...
  // ICI tft.drawString("%RH", M_SIZE*(3 + 230 - 40), M_SIZE*(119 - 20), 2); // Units at bottom right
...
void plotNeedle(int value, byte ms_delay)
{
  ...
  // ICI tft.drawRightString(buf, 33, M_SIZE*(119 - 20), 2);
